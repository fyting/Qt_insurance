    ...
    ui(new Ui::ManagerOper)
{
    ...
    ui->TVSend->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Fixed);
    ui->TVSend->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    //ui->TVSend->horizontalHeader()->setResizeMode(2, QHeaderView::Fixed);
    ui->TVSend->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
    ...
    //设置列宽不可变动，即不能通过鼠标拖动增加列宽
    ui->TVReci->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Fixed);
    ui->TVReci->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    //ui->TVReci->horizontalHeader()->setResizeMode(2, QHeaderView::Fixed);
    ui->TVReci->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
    ...
    //设置列宽不可变动，即不能通过鼠标拖动增加列宽
    ui->TVInsurance->horizontalHeader()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
    ui->TVInsurance->horizontalHeader()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
    //ui->TVInsurance->horizontalHeader()->setResizeMode(2, QHeaderView::Fixed);
    ui->TVInsurance->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
    ui->TVInsurance->horizontalHeader()->setSectionResizeMode(3, QHeaderView::ResizeToContents);
    ui->TVInsurance->horizontalHeader()->setSectionResizeMode(4, QHeaderView::ResizeToContents);
    //设置表格的各列的宽度值
    ...
    //设置列宽不可变动，即不能通过鼠标拖动增加列宽
    ui->TVInsuranceall->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Fixed);
    ui->TVInsuranceall->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    //ui->TVInsuranceall->horizontalHeader()->setResizeMode(2, QHeaderView::Fixed);
    ui->TVInsuranceall->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
    ...
    ui->TVInsuranceall->setColumnWidth(2,90);
