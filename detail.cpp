...
void Detail::set_policyid(int _policyid)
{
    ...
    ui->TVPolicycontent->horizontalHeader()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
    ui->TVPolicycontent->horizontalHeader()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
    //ui->TVPolicycontent->horizontalHeader()->setResizeMode(2, QHeaderView::Fixed);
    ui->TVPolicycontent->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
    //设置表格的各列的宽度值
