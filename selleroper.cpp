    ...
    ui(new Ui::SellerOper)
{
    ...
    //设置列宽不可变动，即不能通过鼠标拖动增加列宽
    ui->TVInsuranceget->horizontalHeader()->setSectionResizeMode(0, QHeaderView::Fixed);
    ui->TVInsuranceget->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Fixed);
    //ui->TVInsuranceget->horizontalHeader()->setResizeMode(2, QHeaderView::Fixed);
    ui->TVInsuranceget->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
